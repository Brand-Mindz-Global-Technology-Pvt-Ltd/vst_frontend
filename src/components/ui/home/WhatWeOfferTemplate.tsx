...
const ServiceCard: React.FC<ServiceData> = ({
    ...
    return (
        <div className="relative group overflow-hidden rounded-[20px] bg-white aspect-4/5 sm:aspect-4/5 md:aspect-4/5 lg:aspect-16/10">
            {/* Background Image */}
            ...
            {icon && (
                <div className="absolute top-0 left-0 z-20">
                    <div className="relative bg-[#f1f8ff] p-2.5 sm:p-2.5 md:p-3 lg:p-5 rounded-tl-[10px] rounded-br-[20px] sm:rounded-br-[22px] md:rounded-br-[28px] lg:rounded-br-[40px] flex items-center justify-center">
            ...
            <div className="absolute bottom-0 right-0 z-20">
                <div className="relative bg-[#f1f8ff] p-2 sm:p-2 md:p-2.5 lg:p-3   rounded-tl-[20px] sm:rounded-tl-[20px] md:rounded-tl-[23px] lg:rounded-tl-[25px] flex items-center">

                    {/* Scoop extending left along bottom edge */}
                    <div className="absolute bottom-0 right-full w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-16 lg:h-16 overflow-hidden pointer-events-none">
                        <div className="w-full h-full rounded-br-[12px] sm:rounded-br-[15px] md:rounded-br-[18px] lg:rounded-br-[20px] shadow-[6px_6px_0_0_#f1f8ff] sm:shadow-[8px_8px_0_0_#f1f8ff] md:shadow-[10px_10px_0_0_#f1f8ff] lg:shadow-[16px_16px_0_0_#f1f8ff]"></div>
                    </div>

                    {/* Scoop extending up along right edge */}
                    <div className="absolute bottom-full right-0 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-16 lg:h-16 overflow-hidden pointer-events-none">
                        <div className="w-full h-full rounded-br-[12px] sm:rounded-br-[15px] md:rounded-br-[18px] lg:rounded-br-[25px] shadow-[6px_6px_0_0_#f1f8ff] sm:shadow-[8px_8px_0_0_#f1f8ff] md:shadow-[10px_10px_0_0_#f1f8ff] lg:shadow-[16px_16px_0_0_#f1f8ff]"></div>
                    </div>

                    {/* Enquiry Button */}
                    <button
                        onClick={onCtaClick}
                        className="bg-black text-white pl-4 sm:pl-4 md:pl-5 lg:pl-8 pr-1 sm:pr-1.5 md:pr-1.5 lg:pr-2.5 py-1 sm:py-1.5 md:py-1.5 lg:py-2 rounded-full font-medium flex items-center gap-2 sm:gap-2 md:gap-2.5 lg:gap-4 group/btn hover:bg-[#007ebb] transition-all transform hover:scale-105 active:scale-95 shadow-xl">
